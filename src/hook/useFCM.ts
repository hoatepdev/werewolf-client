...
function getRegistrationKey(roomCode: string, participantKind: ParticipantKind) {
...
function markRoomRegistered(roomCode: string, participantKind: ParticipantKind) {
  const key = getRegistrationKey(roomCode, participantKind)
  if (!key) return
  localStorage.setItem(key, 'registered')
}

function clearRoomRegistered(roomCode: string, participantKind: ParticipantKind) {
  const key = getRegistrationKey(roomCode, participantKind)
  if (!key) return
